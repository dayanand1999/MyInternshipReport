...
<div id="container" style="background-color:teal;border:1px solid black;border-radius:25px;text-align:center;margin:100px 300px;
			...
			Your Account No : <input type="number" name="accNo1" required> <br><br>
			
			Enter the Receiving Account No : <input type="number" name="accNo2" required> <br><br>
			
			Enter the Amount for Transfer : <input type="number" name="amt" required> <br><br>
